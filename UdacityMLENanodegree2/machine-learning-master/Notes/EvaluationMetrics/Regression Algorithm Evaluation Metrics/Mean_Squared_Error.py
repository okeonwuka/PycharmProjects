...
# Get the decision tree regressor Mean Square Error, dtr_mse, using the 'tests' ie labels_test and features_test
dtr_mse = mse(labels_test, reg1.predict(features_test))

print "Decision Tree mean absolute error: {:.2f}".format(mse(labels_test, reg1.predict(features_test)))
...
# Get the linear Regression regressor Mean Square Error, lr_mse, using the 'tests' ie labels_test and features_test
lr_mse = mse(labels_test, reg2.predict(features_test))

print "Linear regression mean absolute error: {:.2f}".format(mse(labels_test, reg2.predict(features_test)))
